...
from .planetary_gear_env_cfg import PlanetaryGearEnvCfg
from ....agent.agent import Galaxear1GearboxAssemblyAgent
from ....agent.finite_state_machine import StateMachine, Context, InitializationState

class PlanetaryGearEnv(DirectRLEnv):
    cfg: PlanetaryGearEnvCfg

    def __init__(self, cfg: PlanetaryGearEnvCfg, render_mode: str | None = None, **kwargs):
